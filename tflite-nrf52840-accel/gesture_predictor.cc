...
int PredictGesture(float* output) {
  ...
  // Average the last n predictions for each gesture, and find which has the highest score.
  ...
  if ((max_predict_index == kNoGesture) ||
    ...
    // Reset the suppression counter so we don't come up with another prediction too soon.
